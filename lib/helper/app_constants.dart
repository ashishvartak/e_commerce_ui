...
import 'package:e_commerce_ui/models/why_us_model.dart';

class AppConstants {
  List<ProductModel> bottomProductList = [
    ProductModel(
      image: "assets/5.png",
      name: "Ikofnor",
      price: 169.99,
  ...
  List<WhyUsModel> whyUsList = [
    WhyUsModel(
      image: "assets/car.png",
      name: "Free Shipping",
      description:
          "All purchases over \$399 are eligible for \nfree shipping via UPS Pack and Ship.",
    ),
    WhyUsModel(
    ...
    WhyUsModel(
      ...
      description:
          "If an item arrived damaged  , you can \nsend it back for a full refund.",
    ),
    WhyUsModel(
